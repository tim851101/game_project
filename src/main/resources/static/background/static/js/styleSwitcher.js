...
function addSwitcher() {
    ...
    if ($("#dlabSwitcher").length == 0) {
        ...
        $('.sidebar-right-trigger').on('click', function toggleHead() {
            console.log('click .sidebar-right-trigger');


            if (headerContent.classList.contains('animate__fadeInDown')) {
                headerContent.classList.remove('animate__fadeInDown');
                headerContent.classList.add('animate__animated', 'animate__fadeOutUp');
                navRight.classList.remove('la-angle-double-up');
                navRight.classList.add('la-angle-double-down');
                shrinkButton.textContent = 'Toggle Expand';
            } else {
                headerContent.classList.remove('animate__fadeOutUp');
                headerContent.classList.add('animate__animated', 'animate__fadeInDown');
                navRight.classList.remove('la-angle-double-down');
                navRight.classList.add('la-angle-double-up');
                shrinkButton.textContent = 'Toggle Shrink';
            }
        });
